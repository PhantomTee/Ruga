...
function RugMascot() {
  return (
    ...
    >
      {/* Body / hoodie */}
      <path
        d="M60 230 Q55 310 50 370 L270 370 Q265 310 260 230 Q240 200 200 195 L160 210 L120 195 Q80 200 60 230Z"
      ...
      <path
        d="M75 170 Q60 120 80 80 Q110 30 160 25 Q210 30 240 80 Q260 120 245 170"
        fill="none" stroke="#000" strokeWidth="5" strokeLinecap="round"
      />

      {/* Eyes — wide cartoon eyes */}
      {/* Left eye */}
      ...
      {/* Mouth — wide smirk showing teeth */}
      ...
      {/* Sketch lines / hatching for texture on cheeks */}
